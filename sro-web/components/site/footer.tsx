...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-16 border-t border-[var(--legacy-panel-border)] bg-[var(--legacy-navbar-bg)] backdrop-blur">
      <div className="mx-auto w-full max-w-[var(--legacy-shell-max)] px-4 py-8 sm:px-6">
        <div className="flex flex-col items-center justify-between gap-6 bg-[var(--legacy-panel-bg)] px-6 py-6 md:flex-row">
